  ...
  <template>
    <div class="max-w-5xl mx-auto p-6 min-h-screen flex flex-col  gap-10">
      ...
      <UTabs :items="tabs" class="w-full max-w-5xl" :tabClass="['text-xl font-semibold py-4']">
        <template #content="{ item }">
          <div class="">
            ...
            <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-2 w-full ">
              <div
      ...
      :key="psicologo.id"
  class="w-full max-w-md bg-white dark:bg-[#1b1718] border border-gray-500 rounded-lg overflow-hidden shadow-lg cursor-pointer hover:shadow-xl transition"
